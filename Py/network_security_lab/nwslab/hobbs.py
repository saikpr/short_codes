"""
NLP Course Project on Hobbs' algorithm for pronoun resolution in python.

"""

import sys
import nltk # Importing natural language tool kit 
from nltk.corpus import names # Importing the names corpora 
from nltk import Tree # Importing Tree
import Queue # Importing Queue to implement Breadth First Search 
